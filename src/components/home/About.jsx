...
export default function About() {
  return (
    <section id="sobre" className="py-28 bg-slate-50">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-lg p-6 max-w-xs">
              <div className="text-4xl font-bold text-[#141444]">
                100%
              </div>
              <div className="text-gray-600 mt-1">
                Soluções desenvolvidas para cada necessidade.
              </div>
            </div>
          ...
          >
            ...
            <div className="mt-10 grid grid-cols-3 gap-6">
              ...
              {[
                ...
                <div key={i}>
                  <div className="text-lg font-semibold text-[#141444]">
                    {item.value}
                  </div>
